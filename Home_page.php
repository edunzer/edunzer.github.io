...
<html lang="en">
  ...
  <body>
    ...
    <div class="container marketing">
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="gray-background-3.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>HTML</h2>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="plain_eggshell_background_by_hardwayjackson-d3etb0i.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Programming</h2>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" alt="500x500" src="Awesome-Web-Design.png" data-holder-rendered="true">
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5 col-md-pull-7">
          <img class="featurette-image img-responsive center-block" alt="500x500" src="Adobe_Photoshop_CS6_icon.svg.png" data-holder-rendered="true">
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" alt="500x500" src="internet-marketing-1.png" data-holder-rendered="true">
        </div>
      </div>
